...
enum DateFormat: String {
    case HHmm, ddMMyyyyHHmm, ddMM, allChatsTimeFormat, messageDetailsTimeFormat, ddMMyyyy, notesTimeFormat
    ...
    var format: String {
        ...
        case .ddMM:
            return "dd.MM."
        case .allChatsTimeFormat, .notesTimeFormat:
            return "calculate"
