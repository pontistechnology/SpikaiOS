...
class TermsAndConditionView: UIView {
    ...
    private let welcomeLabel = CustomLabel(text: .getStringFor(.welcomeToSpika), textSize: 24, textColor: .textPrimary, fontName: .RobotoFlexSemiBold, alignment: .center)
    ...
    let agreeLabel = CustomLabel(text: .getStringFor(.agreeAndContinue), textSize: 18, textColor: .textPrimary, fontName: .RobotoFlexSemiBold, alignment: .center)
