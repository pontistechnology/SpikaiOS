...
class AllChatsView: UIView, BaseView {
    ...
    private let chatLabel = CustomLabel(text: .getStringFor(.chat), textSize: 32, textColor: .textPrimary, fontName: .RobotoFlexSemiBold)
    ...
    func positionSubviews() {
        chatLabel.anchor(top: topAnchor, leading: leadingAnchor, padding: UIEdgeInsets(top: 2, left: 20, bottom: 0, right: 0))
        ...
        searchBar.anchor(top: chatLabel.bottomAnchor, leading: leadingAnchor, trailing: trailingAnchor, padding: UIEdgeInsets(top: 6, left: 12, bottom: 0, right: 12))
        roomsTableView.anchor(top: searchBar.bottomAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor, padding: UIEdgeInsets(top: 4, left: 0, bottom: HomeTabBar.tabBarHeight, right: 0))
