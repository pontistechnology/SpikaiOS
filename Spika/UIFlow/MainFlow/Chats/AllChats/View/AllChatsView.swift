...
class AllChatsView: UIView, BaseView {
    ...
    func positionSubviews() {
        ...
        newChatButton.anchor(leading: leadingAnchor, bottom: bottomAnchor, padding: UIEdgeInsets(top: 0, left: 20, bottom: HomeTabBar.tabBarHeight, right: 0), size: CGSize(width: 52, height: 52))
